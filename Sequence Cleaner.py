...
[3]: the user defines the % of N is allowed. Default value 100, all sequences with ’N’ will be in your ouput, set value to
     0 if you want no sequences with ”N” in your output
    
'''

### https://peterjc.github.io/wiki/Sequence_Cleaner